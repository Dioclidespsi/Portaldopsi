...
import { resetPatientPassword } from '../../../lib/patient-api';
...
function RedefinirSenhaForm() {
  ...
  if (!token) {
    return (
      <div className="shell">
        <h1>Link inválido</h1>
        <p className="sub">Este link de redefinição está incompleto. Peça um novo em <Link href="/paciente/esqueci-senha">Esqueci minha senha</Link>.</p>
      </div>
    );
  }
...
export default function PacienteRedefinirSenhaPage() {
  return (
