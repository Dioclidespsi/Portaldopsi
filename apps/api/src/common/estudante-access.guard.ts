 ...
 */
const ALLOWED_PREFIXES = ['/me', '/courses', '/certificates', '/marketplace', '/document-templates'];
  ...
  canActivate(context: ExecutionContext): boolean {
    ...
    if (!allowed) {
      throw new ForbiddenException(
        'Contas de estudante de psicologia têm acesso apenas ao ambiente de estudos (Cursos, Certificados, Marketplace).',
      );
    }
    return true;
  }
